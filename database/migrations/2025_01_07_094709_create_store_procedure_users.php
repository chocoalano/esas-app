...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        DB::unprepared("
            CREATE PROCEDURE StoreOrUpdateUser(
                IN p_nip VARCHAR(50),
                ...
                IN p_citizen_id_address TEXT,
                IN p_residential_address TEXT,
                IN p_phone VARCHAR(20),
                IN p_placebirth VARCHAR(100),
                IN p_datebirth DATE,
                IN p_gender CHAR(1),
                IN p_blood VARCHAR(5),
                IN p_marital_status VARCHAR(50),
                IN p_religion VARCHAR(50),
                IN p_basic_salary DECIMAL(20,2),
                IN p_salary_type VARCHAR(20),
                IN p_departement VARCHAR(100),
                IN p_levels VARCHAR(100),
                IN p_position VARCHAR(100),
                IN p_approval_line INT,
                IN p_approval_manager INT,
                IN p_join_date DATE,
                IN p_sign_date DATE,
                IN p_bank_name VARCHAR(100),
                IN p_bank_account VARCHAR(50),
                IN p_bank_account_holder VARCHAR(100)
            )
            BEGIN
